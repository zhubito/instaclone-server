...
const resolvers = {
    Query: {
        ...
        getFollowers: (_,{username}, ctx) =>followController.getFollowers(username, ctx),
        getFolloweds: (_,{username}, ctx) =>followController.getFolloweds(username, ctx),
    ...
    Mutation: {
        // User
        register: (_, {input}) => userController.register(input), //{input} es descontructurin de body
